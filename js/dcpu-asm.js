...
(function() {
  var Assembler, Instruction, LabelValue, LitValue, MemValue, Module, RegValue, SpecialValue, Value, dasm,
  ...
  Instruction = (function() {
    ...
    Instruction.prototype.emit = function(stream) {
      ...
      if (this.mOp === dasm.Disasm.OPC_ADV) {
        "";
  ...
  Assembler = (function() {
    ...
    Assembler.prototype.processMemOp = function(tok) {
      if (isNumber(tok)) {
        return "";
      } else if (isReg(tok)) {
        return "";
    ...
    Assembler.prototype.processLine = function(line) {
      var basic_regex, enc, match, opc, toks, valA, valB, _ref;
