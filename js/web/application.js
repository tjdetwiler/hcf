...
(function() {
  ...
  Lem1802 = (function(_super) {
    ...
    Lem1802.prototype.drawChar = function(x, y, c) {
      ...
      for (i = _i = 31; _i >= 0; i = --_i) {
        ...
        if (c[1 - word] & (1 << bit)) {
          ...
          y_ = y + (i % 8);
          this.mCtx.fillStyle = "rgb(200,0,0)";
          this.mCtx.fillRect(x_ * this.mScale, y_ * this.mScale, this.mScale, this.mScale);
        }
      }
      this.mCtx.fillStyle = "rgba(0, 0, 200, 0.5)";
      return this.mCtx.fillRect(x * this.mScale, y * this.mScale, 4 * this.mScale, 8 * this.mScale);
    };
    ...
    Lem1802.prototype.clear = function() {
      ...
      this.mCtx.fillStyle = "rgb(200,0,0)";
      return this.mCtx.fillRect(0, 0, 150, 150);
    };
...
require.define("/webapp.js", function (require, module, exports, __dirname, __filename) {
    // Generated by CoffeeScript 1.3.1
(function() {
  var $, asm, assemble, cpu, dasm, dcpu, decode, dumpMemory, lem1802, onExec, regs, updateDisasm, updateRegs;
