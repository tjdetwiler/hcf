...
(function() {
  ...
  Dcpu16 = (function() {
    ...
    function Dcpu16() {
      var cpu, name, op, x, _i, _j, _len, _len2, _ref, _ref2;
      cpu = this;
      this.mCycles = 0;
      this.mCCFail = false;
...
(function() {
  ...
  MemValue = (function() {
    ...
    function MemValue(asm, reg, lit) {
      ...
      this.mReg = reg;
      this.mLit = lit;
      if ((this.mLit != null) && this.mLit > 0x1f) this.mAsm.incPc();
    }

    MemValue.prototype.emit = function(stream) {
      if (this.mLit != null) return stream.push(this.mLit);
    };
  ...
  LitValue = (function() {
    ...
    function LitValue(asm, lit) {
      this.mAsm = asm;
      this.mLit = lit;
      if (this.mLit > 0x1f) this.mAsm.incPc();
    }

    LitValue.prototype.emit = function(stream) {
      if (this.mLit > 0x1f) return stream.push(this.mLit);
    };
  ...
  LabelValue = (function() {
    ...
    LabelValue.prototype.resolve = function() {
      ...
      if (!(addr != null)) console.log("Undefined label '" + this.mLbl + "'");
      return addr;
    };
  ...
  Assembler = (function() {
    ...
    Assembler.prototype.processLine = function(line) {
      var adv_regex, basic_regex, enc, match, opc, r, toks, valA, valB, _ref, _ref2;
      ...
      if (line[0] === ":") {
        ...
        if (valA.result !== "success") return valA;
        valB = this.processValue(valB);
        if (valB.result !== "success") return valB;
...
require.define("/webapp.coffee", function (require, module, exports, __dirname, __filename) {
  ...
  dumpMemory = function(base) {
    var body, c, col, html, r, row, v, _results;
    body = $("#memdump-body");
    body.empty();
    _results = [];
    for (r = 0; r <= 4; r++) {
