...
(function() {
  var Dcpu16Shell, IStream, asm, cmd, dasm, dcpu, decode, fs, generic_clock, lem1802, shell,
  ...
  Dcpu16Shell = (function(_super) {
    ...
    function Dcpu16Shell() {
      ...
      this.dcpu.addDevice(new lem1802.Lem1802(this.dcpu));
      this.dcpu.addDevice(new generic_clock.GenericClock(this.dcpu));
    ...
    Dcpu16Shell.prototype.do_disasm = function(toks) {
      var addr, disasm, istream, _results;
      addr = toks[0] != null ? parseInt(toks[0]) : 0;
      istream = new IStream(this.dcpu.mMemory, addr);
      _results = [];
