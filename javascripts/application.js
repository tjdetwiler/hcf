...
(function() {
  ...
  Dcpu16 = (function() {
    ...
    function Dcpu16() {
      var cpu, name, op, _i, _j, _len, _len2, _ref, _ref2;
      cpu = this;
      this.mCCFail = false;
    ...
    Dcpu16.prototype.reset = function() {
      var d, r, x, _i, _j, _len, _len2, _ref, _ref2, _results;
      this.mCCFail = false;
    ...
    Dcpu16.prototype.unmapDevice = function(addr) {
      var i, newList, region, _ref;
      newList = [];
      for (i = 0, _ref = this.mMappedRegions.length - 1; 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
        region = this.mMappedRegions[i];
        if (region.base !== addr) newList.push(region);
      }
    ...
    Dcpu16.prototype.loadJOB = function(job) {
      ...
      for (i = 0, _len = _ref.length; i < _len; i++) {
        ...
        bin[i] = x.val;
        this.mSourceMap[i] = x;
        if (!(this.mSourceMap[x.file] != null)) this.mSourceMap[x.file] = [];
    ...
    Dcpu16.prototype.run = function() {
      ...
      cb = function() {
        var i;
        for (i = 0; i <= 10345; i++) {
          if (!cpu.mRunning) break;
          cpu.step();
        }
        if (cpu.mPeriodic != null) return cpu.mPeriodic(cpu);
      };
    ...
    Dcpu16.prototype.step = function() {
      ...
      this.exec(i);
      if (this.mPostExec != null) this.mPostExec(i);
      while (this.mCCFail) {
        i = new Instr(this.mIStream);
        this.mCCFail = i.cond();
    ...
    Dcpu16.prototype.exec = function(i) {
      ...
      if (!(f != null)) return console.log("Unable to execute OPC " + opc);
    ...
    Dcpu16.prototype.doInterrupt = function(n) {
      var ia;
      ia = this.regIA();
      if (ia === 0 || !this.mRunning) return false;
    ...
    Dcpu16.prototype.catchFire = function() {
      var cpu, misbehave;
      cpu = this;
      misbehave = function() {
        switch (cpu.cycles() % 6) {
          case 0:
            return cpu.regPC(cpu.regPC + 2);
          case 1:
            return cpu.regA(~cpu.regA);
          case 2:
            return cpu.mCCFail = true;
          case 3:
            return cpu.interrupt(0xdead);
          case 4:
            return cpu.pop();
          case 5:
            return cpu.push(cpu.regPC());
        }
      };
      return setInterval(misbehave, 1000);
    };
    ...
    Dcpu16.prototype._exec_ifb = function(a, b) {
      if ((a.get(this) & b.get(this)) === 0) return this.mCCFail = true;
    };
    ...
    Dcpu16.prototype._exec_ife = function(a, b) {
      if (a.get(this) !== b.get(this)) return this.mCCFail = true;
    };
    ...
    Dcpu16.prototype._exec_hwi = function(a) {
      ...
      i = a.get(this);
      dev = this.mDevices[i];
      if (dev != null) return dev.hwInterrupt();
    };

    Dcpu16.prototype._exec_hcf = function(a) {
...
(function() {
  ...
  Instr = (function() {
    ...
    function Instr(stream) {
      var _ref;
      this.mIStream = stream;
      this.mAddr = this.mIStream.getPC();
    ...
    Instr.prototype.valid = function() {
    ...
    Instr.prototype.OPCODE_MASK = 0x001f;

    Instr.prototype.VALB_MASK = 0x03e0;

    Instr.prototype.VALA_MASK = 0xfc00;
...
(function() {
  ...
  Device = (function() {
    ...
    Device.prototype.interrupt = function(m) {
      console.log("" + this.mName + " sending interrupt " + m);
...
(function() {
  var Device, GenericClock, Module;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
